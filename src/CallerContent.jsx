...
import "./css/CallerContent.css";
import "core-js/stable";
import "regenerator-runtime/runtime";

class CallerContent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      allCalls: [],
  ...
  async fetchAndSetData() {
    try {
      ...
      const filteredCalls =
        this.state.activeTab === "unarchived"
    ...
    return (
      <div className="content">
        <div className="content-header">
          <ul>
            <li
              className={this.state.activeTab === "unarchived" ? "active" : ""}
              onClick={() => this.setState({ activeTab: "unarchived" })}
            >
              Unarchived Calls
            </li>
            <li
            ...
            <div className="callCard" key={call.id}>
              ...
              >
                <div className="callCardDetails">
                  ...
                  >
                    {call.direction === "outbound" && <BiSolidPhoneOutgoing/>}
                    {call.direction === "inbound" && <BiSolidPhoneIncoming/>}
                    {call.direction === undefined && <FcMissedCall />}
                  </span>
                  <span
